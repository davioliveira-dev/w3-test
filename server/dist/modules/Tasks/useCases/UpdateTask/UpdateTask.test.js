...
(0, node_test_1.describe)("Negative cases for UpdateTaskUseCase", () => {
    let repositoryMock = {
    ...
    (0, node_test_1.it)("should throw an error if the task title is not a string", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const updateTaskUseCase = new index_1.UpdateTaskUseCase(repositoryMock);
        const result = yield updateTaskUseCase
...
(0, node_test_1.describe)("Positive cases for updateTaskUseCase", () => {
    let repositoryMock = {
        findAll: node_test_1.mock.fn(),
        findById: node_test_1.mock.fn(),
        findByTitle: node_test_1.mock.fn(),
    ...
    (0, node_test_1.it)("should update a task", () => __awaiter(void 0, void 0, void 0, function* () {
        repositoryMock.findById = node_test_1.mock.fn(() => Promise.resolve({
            id: 1,
            title: "Task 1",
            isDone: false,
        ...
        repositoryMock.update = node_test_1.mock.fn(() => Promise.resolve({
            id: 1,
            title: "Task 11",
            isDone: false,
            createdAt: new Date(),
        ...
        const updateTaskUseCase = new index_1.UpdateTaskUseCase(repositoryMock);
        const result = yield updateTaskUseCase.execute({ id: 1, title: "Task 11" });
        node_assert_1.default.strictEqual(result.title, "Task 11");
    }));
    (0, node_test_1.it)("should update a task with isDone true", () => __awaiter(void 0, void 0, void 0, function* () {
        repositoryMock.findById = node_test_1.mock.fn(() => Promise.resolve({
            id: 1,
            title: "Task 1",
            isDone: false,
        ...
        const updateTaskUseCase = new index_1.UpdateTaskUseCase(repositoryMock);
        const result = yield updateTaskUseCase.execute({
            id: 1,
            isDone: true,
        });
