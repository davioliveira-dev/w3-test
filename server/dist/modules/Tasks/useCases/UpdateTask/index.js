...
class UpdateTaskUseCase {
    ...
    execute(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const task = yield this.tasksRepository.findById(params.id);
            if (!task) {
            ...
            if (params.title) {
                ...
                const taskWithSameTitle = yield this.tasksRepository.findByTitle(params.title);
            ...
            const updatedTask = yield this.tasksRepository.update(params);
            return updatedTask;
        });
    }
}
